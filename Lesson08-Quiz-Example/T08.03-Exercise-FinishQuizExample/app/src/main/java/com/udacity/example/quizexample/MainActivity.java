...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the views
        // X (1) You'll probably want more than just the Button
    ...
    public void nextWord() {
        ...
        // X (3) Go to the next word in the Cursor, show the next word and hide the definition
        ...
        if (mData != null) {
            ...
            mDef.setText(mData.getString(defCol));
        }
    ...
    protected void onDestroy() {
        super.onDestroy();
        // X (5) Remember to close your cursor!
        mData.close();
    }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... params) {
            ...
            Log.d("CONTENTRESOLVER: ", resolver.toString());
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            // X (2) Initialize anything that you need the cursor for, such as setting up
            ...
            if (mData != null) {
                ...
                nextWord();
                Log.d("DEF / WORD:", mWord.getText().toString() + "-" + mDef.getText().toString());
            }
        }
    }
